...
function compare() {
	...
	if (humanActiveCard.rank > computerActiveCard.rank) {
		winText.textContent = 'YOU LOS3 M4RQU1S3'
		...
		loseText.textContent = 'Nice try Neophyte.'
		...
		winText.textContent = 'W4R'
		loseText.textContent = 'War'
		humanDeck.splice(humanDeckIndex, 1)
		computerDeck.splice(computerDeckIndex, 1)
...
const winText = document.querySelector('span#win')
const loseText = document.querySelector('span#lose')
